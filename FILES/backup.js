...
// Initialisation des livres dans localStorage si nécessaire
if (!localStorage.getItem('livres')) {
    localStorage.setItem('livres', JSON.stringify(data.livres));
}

// Initialisation du tableau des livres supprimés dans localStorage si nécessaire
...
function afficherLivres() {
    ...
    container.innerHTML = ''; // Vider le contenu actuel du conteneur
...
// Appeler afficherLivres au chargement de la page pour afficher les livres
afficherLivres();
...
// Fonction pour afficher les livres filtrés par catégorie
